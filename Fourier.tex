...
\begin{figure}[h]
    \centering
    %%\includegraphics[scale=0.5]{Figuras/F_12_2.jpg}
    \includegraphics[scale=0.5]{Figuras/Serie-transformada.jpg}
    %%\medskip
    \\
...
\begin{figure}[h]
    \centering
    %%\includegraphics[scale=0.5]{Figuras/F_12_3.jpg}
    \includegraphics[scale=0.5]{Figuras/Serie-transformada.jpg}
    %%\medskip
    \\
...
\begin{figure}[h]
    \centering
    %%\includegraphics[scale=0.5]{Figuras/F_12_4.jpg}
    \includegraphics[scale=0.5]{Figuras/Serie-transformada.jpg}
    %%\medskip
    \\
...
\begin{figure}[h]
    \centering
    %%\includegraphics[scale=0.5]{Figuras/F_12_5.jpg}
    \includegraphics[scale=0.5]{Figuras/Serie-transformada.jpg}
    %%\medskip
    \\
